...
Tests all functions in preprocessing/ folder including:
- ants_transform.py
...
# Try to import preprocessing modules - handle import errors gracefully
try:
...
class TestNiftiPreprocessing:
    """Test nifti_resampling.py functions"""
...
def test_module_structure():
    ...
    assert os.path.isdir(preprocessing_path)
    ...
    for filename in expected_files:
        filepath = os.path.join(preprocessing_path, filename)
