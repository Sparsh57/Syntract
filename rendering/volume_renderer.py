...
try:
    from rendering.volume_processing import process_volume_full_3d
except ImportError:
    from volume_processing import process_volume_full_3d
...
def create_3d_volume_with_streamlines(nifti_file, trk_file, output_file,
    ...
    """
    for label, path in (("NIfTI", nifti_file), ("TRK", trk_file)):
    ...
    if white_mask_path and os.path.exists(white_mask_path):
        try:
            ...
            # Resample to match NIfTI dimensions if needed (following patch_extraction.py approach)
    ...
    if enable_tissue_artifacts or enable_granular_noise or enable_speckle_noise or enable_dash_noise or enable_horizontal_banding or enable_poisson_noise:
        try:
            ...
            from volume_artifact_augmentation import apply_image_only_augmentations
